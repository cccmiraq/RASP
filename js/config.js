...
// traffic lights rules
	...
	if (tl == "protect"){
			if (v == "yes" || v == "Yes" || v == "TRUE" || v == "More than 75%" || v == "Between 50% and 75%" || v== "more_75%" || v =="btw_50%_75%") {
				return "success"
			}
			else if (v == "no" || v == "No" || v == "none" || v == "FALSE" || v == "Less than 25%" || v == "less_25%") {
				return "danger"
			}
			else {
				return "warning"
	...
	if (tl == "wash"){
			if (v == "yes" || v == "Yes" || v == "TRUE" || v == "More than 75%" || v > 0  || v == "Between 25% and 50%" || v == "Between 50% and 75%" || v== "more_75%" || v =="btw_50%_75%") {
				return "success"
			}
			else if (v == "no" || v == "No" || v == "none" || v == "FALSE" || v == "Less than 25%" || v == "never" || v ==0 || v == "less_25%") {
				return "danger"
			}
			else {
				return "warning"
	...
	if (tl == "risk"){
			if (v == "Very High Risk" || v=="very high risk" || v=="High Risk" || v=="high risk" || v == "Very High Risk " || v=="very high risk " || v=="High Risk " || v=="high risk ") {
				return "danger"
			}
